...
Commontator.configure do |config|
  ...
  config.current_user_proc = lambda { |controller| controller.current_frontend_user }
  ...
  #                                         locals: {
  #                                             avatar_url: user.decorate.try(:photo).to_s
  #                                         })
  # }
  ...
  config.thread_read_proc = lambda { |thread, user| thread.commontable.is_commentable?; }
